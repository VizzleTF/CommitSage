...
export function buildWebviewL10n(): WebviewL10n {
    return {
        ...
        maxOutputTokens: vscode.l10n.t('Max output tokens'),
        maxOutputTokensHint: vscode.l10n.t('Output budget per message, all providers. Reasoning models spend it on thinking too, so a low value cuts the message off. Default 4096.'),
        geminiThinkingBudget: vscode.l10n.t('Thinking budget (Gemini 2.5)'),
        geminiThinkingBudgetHint: vscode.l10n.t('0 = no thinking (recommended), -1 = model decides. Gemini 2.5 Pro cannot disable it and uses 128 minimum.'),
        geminiThinkingLevel: vscode.l10n.t('Thinking level (Gemini 3)'),
        geminiThinkingLevelHint: vscode.l10n.t('Gemini 3 always thinks. Higher levels cost more tokens and time; low is ample for commit messages.'),
